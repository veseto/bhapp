...
//	$leagues = array('FRANCE' => array('CHAMPIONNAT+NATIONAL'));

	foreach ($seasons as $season) {

		$seasonName = str_replace("%2F", "-", $season);
		$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=POLAND&leagueName=DIVISION+2&seasonName=2013%2F2014&sortBy=R&result=3";
		...
		$firstRound = 110937;//$select->firstChild->getAttribute('value');
		$roundCount = 34;//$select->lastChild->nodeValue;
		...
		for ($j = 0; $j < $roundCount; $j ++) {
			...
			$url = "http://www.xscores.com/soccer/Results.jsp?sport=1&countryName=POLAND&leagueName=DIVISION+2&seasonName=2013%2F2014&sortBy=R&round=$n&result=3";

	...
	<div class="col-md-4">
    	<ul class="list-group">
      		<li class="list-group-item">
        		<img src="img/<?=$row['country']?>.png" class="pullup" /> <span class="badge"><?=$badge ?></span><a href="<?php echo "standingsdetails.php?league=".$row['leagueId']; ?>"><?php echo $row['country']." ".$row['name'];?></a>
			</li>
    	</ul>
  	</div>
<?php	

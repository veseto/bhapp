<?php
	...
	$leagues = array('TURKEY' => array('SUPER+LIG'));
foreach ($leagues as $country => $leaguesArray) {
	...
	//		echo $serie['seriesId']."<br>";
		...
		$sec = time() - $start;
	file_put_contents("/var/www/bh/data_manage/updateStats.txt", "TURKEY ".date("Y-m-d h:i:s", time())." - seconds: ".$sec."  updated matches: ".$updatedMatches."  added matches to play: ".$updatedMatchesToPlay."\n", FILE_APPEND);
?>